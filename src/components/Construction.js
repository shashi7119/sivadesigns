...
const API_URL = 'https://www.wynstarcreations.com/seyal/api/getMasters?type=construction';
      ...
      <Container fluid className="relative">
        <Row className="mb-6">
          <div className="col-10 col-sm-10">
            <h1 className="text-2xl font-bold text-gray-800">Construction Master</h1>
